...
/** @module Page Summary
@icon newspaper-o
@summary The page summary displays critical information and actions that users need to access quickly and frequently.
 @description The page summary displays critical information and actions that users want to access quickly and frequently. The parent `bb-page-summary` directive can contain multiple directives, and each of them is optional. You select the directives to include in the summary based on the type of page and the scenario you design for.
...
### Record Status
You can display important status information about a page's content with labels in the record status section of the page summary.

You use the `bb-page-summary-status` directive to display the record status section. You typically display the labels with  a series of `span` elements and the [Bootstrap CSS classes for labels](http://getbootstrap.com/components/#labels).
...
You use the `bb-page-summary-content` directive to display the arbitrary information section.
